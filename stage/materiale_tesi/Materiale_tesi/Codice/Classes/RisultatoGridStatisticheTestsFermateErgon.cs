...
{
    class RisultatoGridStatisticheTestsFermateErgon
    {
        ...
        public RisultatoGridStatisticheTestsFermateErgon(string _tipo_test, string _descrizione, int _passo, string _risultato,int _dim_tren)
        {
